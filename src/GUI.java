...
public class GUI {
    ...
    public GUI() {
        ...
        // Left Panel with two much wider columns
        ...
        // Add Run Model Button at the bottom of the left panel
        ...
        // Panel for additional buttons, aligned to the center under the table
        ...
        // Add buttons panel directly below the table (aligned within the table area)
    ...
    private void runModel() {
        try {
            ...
            if (modelName == null || dataFile == null) {
                JOptionPane.showMessageDialog(frame, "Please select a model and a data file.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
